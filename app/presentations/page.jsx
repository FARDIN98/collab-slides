          ...
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden sm:flex items-center space-x-2 bg-white/60 backdrop-blur-sm rounded-full px-4 py-2 border border-white/30">
                ...
                <span className="bg-gradient-to-r from-gray-700 via-gray-800 to-gray-700 bg-clip-text text-transparent font-bold tracking-wide hover:from-blue-600 hover:via-purple-600 hover:to-indigo-600 transition-all duration-300 cursor-default">
                  Welcome, {nickname}!
                </span>
              </div>
              <Button
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center space-x-2 text-sm text-gray-500">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent hover:from-blue-500 hover:to-blue-700 transition-all duration-200 cursor-default">
                      Creator
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                    <span className="font-bold bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent hover:from-green-500 hover:to-green-700 transition-all duration-200 cursor-default">
                      Editor
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 bg-gray-500 rounded-full"></div>
                    <span className="font-bold bg-gradient-to-r from-gray-600 to-gray-800 bg-clip-text text-transparent hover:from-gray-500 hover:to-gray-700 transition-all duration-200 cursor-default">
                      Viewer
                    </span>
                  </div>
                </div>
            ...
            {presentationsLoading ? (
              ...
              <div className="px-8 py-20 text-center">
                ...
                <p className="text-gray-600 mb-8 max-w-md mx-auto">
                  Start your collaborative journey by creating your first
                  presentation. Invite team members and work together in
                  real-time.
                </p>
                <Button
                  onClick={() => setIsModalOpen(true)}
                  ...
                  {presentations.map((presentation, index) => (
                    ...
                    >
                      ...
                      <CardHeader className="pb-4 relative z-10">
                        ...
                        <div className="flex items-start justify-between mb-4">
                          ...
                          {presentation.user_role ? (
                            ...
                            <Badge
                              variant="outline"
                              className="shrink-0 bg-gradient-to-r from-amber-500 to-orange-500 text-white border-0 shadow-lg shadow-orange-200 transform hover:scale-105 transition-transform duration-200"
                            >
                              <svg
                                className="w-3 h-3 mr-1"
                                fill="none"
                          ...
                          <div className="flex items-center space-x-3">
                            <div className="relative">
                              <div className="flex items-center space-x-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-4 py-2 rounded-xl shadow-lg shadow-indigo-200 transform hover:scale-105 transition-all duration-200">
                                ...
                                <span className="font-extrabold text-sm bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent hover:from-yellow-200 hover:via-white hover:to-yellow-200 transition-all duration-300 tracking-wide transform hover:scale-105 cursor-default">
                                  {presentation.slides_count || 0} slide
                                  {(presentation.slides_count || 0) !== 1
                                    ? "s"
                                    : ""}
                                </span>
                              </div>
                            ...
                            {presentation.slides_count > 5 && (
                              <div className="flex items-center space-x-1 px-3 py-1.5 bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-xs font-bold rounded-lg shadow-md shadow-emerald-200 transform hover:scale-105 transition-all duration-200">
                                ...
                                <span className="font-extrabold bg-gradient-to-r from-white via-emerald-100 to-white bg-clip-text text-transparent hover:from-yellow-200 hover:via-white hover:to-yellow-200 transition-all duration-300 tracking-widest transform hover:scale-110 cursor-default">
                                  Rich
                                </span>
                              </div>
                            )}
                      ...
                      <CardFooter className="pt-0">
                        <Button
                          onClick={() =>
                            handleJoinPresentation(presentation.id)
                          }
